...
const CardMovies = ({ movie }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-y-2 rounded-lg border border-black/[0.1] bg-[#f7f7f7]">
      <Image
      ...
      <div className="flex flex-col gap-y-2 px-4 py-2 flex-grow">
        ...
        <Link
          href={`/movies/detail/tmdb-${movie.id}`}
          className="bg-blue-500 text-white w-full py-2 rounded-[16px] text-center hover:bg-blue-600 transition-colors duration-200"
        >
